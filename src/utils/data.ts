  ...
  about: [
    {
      ...
      description: 'Faculty of Management, master’s degree in management of organizations',
      startDate: 'september 2007',
      finishDate: 'august 2008',
    },
    {
      title: 'Moscow humanitarian University, Moscow',
      description: "Finance and credit department, bachelor's degree in financial management",
...
export const Certificates: Data = {
  ...
  about: [
    {
      title: 'Udemy',
      description: 'Additional courses of JavaScript, React and React Redux',
      startDate: 'october 2022',
      finishDate: 'august 2008',
    },
    {
      title: 'Sololearn',
      description: 'Theoretical and practical understanding of JavaScript',
      startDate: 'december 2021',
      finishDate: 'january 2022',
    },
    {
      title: 'Project Management',
      description: 'Project Management Training Programme at the International Black Sea University',
      startDate: 'may 2017',
      finishDate: 'june 2017',
    },
    {
      title: 'Project Management',
      description: 'Project Management courses at the LEPL STC “DELTA”',
      startDate: 'may 2015',
      finishDate: 'june 2015',
    },
    {
      title: 'English language course',
      description: 'English language at the Moscow humanitarian University',
  ...
  about: [
    {
      ...
      description: `Mainly processed the data received from the server 
    ...
    },
    {
      ...
      description: `I was developing UI components in accordance with
    ...
    },
    {
      title: 'JavaScript Developer ',
      company: 'www.Xfusion.app, Georgia/Tbilisi',
      description: `I participated in the development of a form builder,
    ...
    },
    {
      ...
      description: `Participated in a research project for 
    ...
    },
    {
      ...
      company: 'LEPL STC “DELTA, Georgia/Tbilisi',
      description: `Participated in the analysis of 
    ...
    },
    {
      ...
      description: `Accountant in the center of demilitarization`,
    ...
    },
    {
      ...
      description: `Trade - “Auto Accessories Store”`,
...
export const Experience: Data = {
  ...
  about: [
    ...
    },
    {
      ...
      skils: [{ lang: 'Rest API ', logo: '/images/restAPI.png', alt: 'restAPI', rate: 4 }],
    },
    {
      title: 'Authentication',
      skils: [{ lang: 'JSON Web Token (JWT)', logo: '/images/jwt.svg', alt: 'jwt', rate: 3 }],
    },
    {
    ...
    },
    {
      ...
      skils: [{ lang: 'HTML', logo: '/images/html.svg', alt: 'HTML', rate: 4 }],
    },
  ],
};
  ...
  about: [
    {
      personal_details: [
        {
          text: 'mail',
          network: 'kakulia.irakly@gmail.com',
        ...
        {
          text: 'address',
          network: 'Georgia, Tbilisi 0144',
          logo: '/images/direction.png',
          alt: 'address',
          selector: 'h5',
        },
        {
          text: 'linkedin',
          network: 'https://www.linkedin.com/in/irakli-kakulia-b0843a95/',
        ...
        {
          text: 'github',
          network: 'https://github.com/dgebia',
        ...
        {
          text: 'instagram',
          network: 'https://www.instagram.com/kakulia.irakly/',
